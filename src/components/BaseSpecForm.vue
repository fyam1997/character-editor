...
<template>
  <div class="space-y-5" v-if="store.cardJson">
    <section>
      <h2 class="text-sm font-bold text-gray-300 border-b border-gray-700 pb-1 mb-3">Info</h2>
    ...
    <section>
      <h2 class="text-sm font-bold text-gray-300 border-b border-gray-700 pb-1 mb-3">Character</h2>
      <div class="space-y-3">
        <div>
    ...
    <section>
      <h2 class="text-sm font-bold text-gray-300 border-b border-gray-700 pb-1 mb-3">Override Prompt</h2>
      <div class="space-y-3">
        <div>
